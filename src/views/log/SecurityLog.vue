<template>
  <div class="sm-page sm-page--bg">
    ...
    >
      ...
      <el-table-column label="组织" prop="a"></el-table-column>
      <el-table-column label="登录终端型号" prop="a"></el-table-column>
      <el-table-column label="操作系统" prop="a"></el-table-column>
      <el-table-column label="IP" prop="a"></el-table-column>
      <el-table-column label="登录状态" prop="a"></el-table-column>
      <el-table-column label="操作信息" prop="a"></el-table-column>
      <el-table-column label="登录时间" prop="a"></el-table-column>
    </el-table>
